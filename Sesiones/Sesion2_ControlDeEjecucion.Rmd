...
Nótese el uso **parentesis** en la condición. Además, el uso de **{}**  para identificar secciones de comandos (opcional aquí por haber una sola linea de comando). Si la sección del **else{}** el programa funciona, pero no habrá mensaje de por qué no hay resultado mostrado.
