\documentclass[paperVersion_7_matriz.tex]{subfiles}
...
\usepackage{Sweave}
\begin{document}
\input{paperVersion_7_a-concordance}
...
\begin{figure}[h]
\centering
\includegraphics{paperVersion_7_a-barplots}
...
% Date and time: Wed, May 30, 2018 - 12:53:01
...
% Table created by stargazer v.5.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Wed, May 30, 2018 - 12:53:04
\begin{table}[!htbp] \centering 
...
\includegraphics{paperVersion_7_a-corrPlotX}
\end{adjustbox}
...
\includegraphics{paperVersion_7_a-plotMap1}
\end{adjustbox}
